...
export default {
  ...
  logUpdate: (req, res, logs) => new Promise((resolve, reject) => {
    const objLogger = loggerFormat(req, res);
  ...
  logBLOCKDED: (req, res, logs) => new Promise((resolve, reject) => {
    const objLogger = loggerFormat(req, res);
    const { /* userId, */ dataReqQuery, dataReqBody,dataRes } = logs;
    const createDate = moment();// moment().tz(tz).format('YYYY-MM-DD HH:mm:ss');
  ...
  logAPPROVED: (req, res, logs) => new Promise((resolve, reject) => {
    const objLogger = loggerFormat(req, res);
    const { /* userId, */ dataReqQuery, dataReqBody,dataRes } = logs;
    const createDate = moment(); // moment().tz(tz).format('YYYY-MM-DD HH:mm:ss');
    const ip = getIpAddress(req);
  ...
  logVIEWED: (req, res, logs) => new Promise((resolve, reject) => {
    const objLogger = loggerFormat(req, res);
    const { /* userId, */ dataReqQuery, dataReqBody,dataRes } = logs;
    const createDate = moment(); // moment().tz(tz).format('YYYY-MM-DD HH:mm:ss');
    const ip = getIpAddress(req);
  ...
  logCreate: (req, res, logs) => new Promise((resolve, reject) => {
    const objLogger = loggerFormat(req, res);
    const { /* userId, */ dataReqQuery, dataReqBody,dataRes} = logs;
    const createDate = moment(); //  moment().tz(tz).format('YYYY-MM-DD HH:mm:ss');
  ...
  logDelete: (req, res, logs) => new Promise((resolve, reject) => {
    const objLogger = loggerFormat(req, res);
    const { /* userId, */ dataReqQuery, dataReqBody,dataRes } = logs;
    const createDate = moment();//  moment().tz(tz).format('YYYY-MM-DD HH:mm:ss');
