...
router.post('/savePageToken', facebookController.savePageToken);
router.get('/statistics/:id', facebookController.getStatistics);
...
router.post('/getGroup', facebookController.getGroup);
router.post('/checkAccesToken', facebookController.checkAccesToken);
