...
export default {
  authenCreate: (req, res, next) => {
    ...
    const { provinceName,dateCreated,dateUpdated,points, status } = req.body;
    const province = { provinceName,dateCreated,dateUpdated,points, status, userCreatorsId };
  ...
  authenUpdate: (req, res, next) => {
    ...
    const { provinceName,dateCreated,dateUpdated,points, status } = req.body;
    const province = { provinceName,dateCreated,dateUpdated,points, status };
  ...
  authenFilter: (req, res, next) => {
    ...
    if (filter) {
      const { id, provinceName,status,userCreatorsId, FromDate, ToDate } = JSON.parse(filter);
      const province = { id, provinceName, status, userCreatorsId, FromDate, ToDate };
