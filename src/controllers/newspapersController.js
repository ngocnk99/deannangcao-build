...
import { createTemplatenews } from '../utils/helper';
...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      newspapersService.get_list(param).then(data => {
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      newspapersService.get_one(param).then(data => {
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      newspapersService.create(param).then(data => {
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      newspapersService.update(param).then(data => {
  ...
  update_status: (req, res, next) => {
    ...
    try {
      ...
      newspapersService.update_status(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
