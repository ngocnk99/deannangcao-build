...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      socialsService.get_list(param).then(data => {
        ...
        res.header('Content-Range', `socialsController ${range}/${data.count}`);
        res.send(dataOutput);
        // write log
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      socialsService.get_one(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      socialsService.create(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      socialsService.update(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  update_status: (req, res, next) => {
    ...
    try {
      ...
      socialsService.update_status(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
