import wardService from '../services/wardsService'
...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      wardService.get_list(param).then(data => {
        const dataOutput = {
          result: {
            list: data.rows,
            pagination: {
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      // console.log("wardService param: ", param)
      wardService.get_one(param).then(data => {
        res.send(data);
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      wardService.create(param).then(data => {
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      wardService.update(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
  ...
  delete: (req, res, next) => {
    ...
    try {
      ...
      wardService.delete(param).then(data => {
  ...
  update_status: (req, res, next) => {
    ...
    try {
      ...
      wardService.update_status(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
  ...
  get_list_multi: (req, res, next) => {
    ...
    try {
      ...
      wardService.get_list_multi(param).then(data => {
        const dataOutput = {
          points: data,
          success: true,
          errors: [],
