import phasesOfDisastersService from '../services/phasesOfDisastersService'
...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      phasesOfDisastersService.get_list(param).then(data => {
        ...
        res.header('Content-Range', `phasesOfDisastersController ${range}/${data.count}`);
        res.send(dataOutput);
        // write log
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      phasesOfDisastersService.get_one(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      phasesOfDisastersService.create(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      phasesOfDisastersService.update(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  update_status: (req, res, next) => {
    ...
    try {
      ...
      phasesOfDisastersService.update_status(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
