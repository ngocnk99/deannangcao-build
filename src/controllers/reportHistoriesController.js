import reportHistoriesSerivce from '../services/reportHistoriesSerivce'
...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      reportHistoriesSerivce.get_list(param).then(data => {
        const dataOutput = {
          result: {
            list: data.rows,
            pagination: {
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      reportHistoriesSerivce.get_one(param).then(data => {
        res.send(data);
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      reportHistoriesSerivce.create(param).then(data => {
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      reportHistoriesSerivce.update(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
  ...
  update_status: (req, res, next) => {
    ...
    try {
      ...
      reportHistoriesSerivce.update_status(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
