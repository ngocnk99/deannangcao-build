...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      areasService.get_list(param).then(data => {
  ...
  get_list_multi: (req, res, next) => {
    ...
    try {
      ...
      areasService.get_list_multi(param).then(data => {
        const dataOutput = {
          points: data,
          success: true,
          errors: [],
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      areasService.get_one(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      areasService.create(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      areasService.update(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  update_status: (req, res, next) => {
    ...
    try {
      ...
      areasService.update_status(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
