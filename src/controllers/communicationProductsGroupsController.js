import communicationProductsGroupsService from '../services/communicationProductsGroupsService'
...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      communicationProductsGroupsService.get_list(param).then(data => {
        ...
        res.header('Content-Range', `communicationProductsGroupsController ${range}/${data.count}`);
        res.send(dataOutput);
        // write log
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      communicationProductsGroupsService.get_one(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      communicationProductsGroupsService.create(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      communicationProductsGroupsService.update(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  update_status: (req, res, next) => {
    ...
    try {
      ...
      communicationProductsGroupsService.update_status(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
