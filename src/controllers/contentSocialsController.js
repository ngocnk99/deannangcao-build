import contentSocialsService from '../services/contentSocialsService';
import loggerFormat, { recordStartTime } from '../utils/loggerFormat';
import * as ApiErrors from '../errors';
import loggerHelpers from '../helpers/loggerHelpers';

export default {
  get_list_v2: (req, res, next) => {
    ...
    try {
      ...
      contentSocialsService
        ...
        .then(data => {
          ...
          res.header('contentSocial-Range', `contentSocialsController ${range}/${data.count}`);
          res.send(dataOutput);
          // write log
    ...
    try {
      ...
      contentSocialsService
        ...
        .then(data => {
          ...
          res.header('contentSocial-Range', `sclSocialAccounts ${range}/${data.count}`);
          res.send(dataOutput);
          // write log
          recordStartTime.call(res);
          // loggerHelpers.logVIEWED(req, res, {
