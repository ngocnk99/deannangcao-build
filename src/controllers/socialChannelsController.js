import socialChannelsService from '../services/socialChannelsService'
...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      socialChannelsService.get_list(param).then(data => {
        ...
        res.header('Content-Range', `socialChannelsController ${range}/${data.count}`);
        res.send(dataOutput);
        // write log
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      socialChannelsService.get_one(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      socialChannelsService.create(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      socialChannelsService.update(param).then(data => {
        const objLogger = loggerFormat(req, res);
  ...
  update_status: (req, res, next) => {
    ...
    try {
      ...
      socialChannelsService.update_status(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
