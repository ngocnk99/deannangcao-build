import systemsConfigsService from '../services/systemsConfigsService'
...
export default {
  get_one: (req, res, next) => {
    ...
    try {
      ...
      systemsConfigsService.get_one(param).then(data => {
        res.send(data);
  ...
  createOrUpdate: (req, res, next) => {
    ...
    try {
      ...
      systemsConfigsService.createOrUpdate(param).then(data => {
  ...
  update_status: (req, res, next) => {
    ...
    try {
      ...
      systemsConfigsService.update_status(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
