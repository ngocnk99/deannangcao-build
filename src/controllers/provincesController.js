...
export default {
  get_list: (req, res, next) => {
    ...
    try {
      ...
      provincesService.get_list(param).then(data => {
        const dataOutput = {
          result: {
            list: data.rows,
            pagination: {
  ...
  get_list_multi: (req, res, next) => {
    ...
    try {
      ...
      provincesService.get_list_multi(param).then(data => {
        const dataOutput = {
          points: data,
          success: true,
          errors: [],
  ...
  get_one: (req, res, next) => {
    ...
    try {
      ...
      provincesService.get_one(param).then(data => {
        res.send(data);
  ...
  create: (req, res, next) => {
    ...
    try {
      ...
      provincesService.create(param).then(data => {
  ...
  update: (req, res, next) => {
    ...
    try {
      ...
      provincesService.update(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
  ...
  delete: (req, res, next) => {
    ...
    try {
      ...
      provincesService.delete(param).then(data => {
  ...
  update_status: (req, res, next) => {
    ...
    try {
      ...
      provincesService.update_status(param).then(data => {
        if (data && data.result) {
          const dataOutput = {
            result: data.result,
            success: true,
